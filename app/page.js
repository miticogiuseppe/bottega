                        ...
                        <Card.Body className="">
                          ...
                          <div className="btn-list text-center mt-3">
                            <SpkButton
                              ...
                              Buttontype="button"
                            >
                              <i className="ri-facebook-line lh-1 align-center fs-17" />
                            </SpkButton>
                            <SpkButton
                              ...
                              Buttontype="button"
                            >
                              <i className="ri-twitter-x-line lh-1 align-center fs-17" />
                            </SpkButton>
                            <SpkButton
                              ...
                              Buttontype="button"
                            >
                              <i className="ri-instagram-line lh-1 align-center fs-17" />
                            </SpkButton>
                          </div>
                        </Card.Body>
                      </Tab.Pane>
                          ...
                          <div className="row gy-3">
                            ...
                            <div className="col-xl-12 mb-2">
                              ...
                              >
                                ...
                                <Link
                                  href="/authentication/reset-password/basic"
                                  className="float-end fw-normal text-danger"
                                >
                                  Forget password ?
                                </Link>
                              </label>
