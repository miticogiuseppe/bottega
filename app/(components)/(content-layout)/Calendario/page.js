...
export default function Home() {
  ...
  useEffect(() => {
    // Carica automaticamente il file Excel
      ...
      console.log("Ordini caricati da public/data/APPMERCE-000.xlsx", newOrders); // Debug
  ...
  return (
   <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4">Calendario Ordini APPMERCE di Copral 📅</h1>
