          ...
          <ul className="header-content-right">
            ...
            <SpkDropdown Customclass="header-element cart-dropdown" toggleas="a" Navigate='#!' Svg={true} Customtoggleclass='header-link dropdown-toggle no-caret' Badgetag={true} Badgeclass='header-icon-badge' Menuclass='main-header-dropdown dropdown-menu-start'
              ...
              <div className={`p-3 empty-header-item border-top d-flex gap-2 align-items-center ${cartItemCount === 0 ? 'd-none' : 'd-block'}`}>
                <Link href="#!" className={`btn flex-fill btn-primary btn-wave ${cartItemCount === 0 ? 'd-none' : 'd-block'}`}>Proceed to checkout</Link>
              </div>
              <div className={`p-5 empty-item ${cartItemCount === 0 ? 'd-block' : 'd-none'}`}>
                <div className="text-center">
                  ...
                  <Link href="#!" className="btn btn-primary1 btn-wave btn-sm m-1" data-abc="true">continue shopping <i className="bi bi-arrow-right ms-1"></i></Link>
                </div>
              </div>
                    ...
                    <li className='dropdown-item' key={notification.id}>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-grow-1 d-flex align-items-center justify-content-between">
                          <div>
                            <p className="mb-0 fw-medium"><Link href="#!">{notification.heading}</Link></p>
                            {notification.data}
            ...
            <SpkDropdown Customclass="header-element" toggleas="a" Navigate='#!' Customtoggleclass='header-link no-caret' Id="mainHeaderProfile" Imagetag={true}
              ...
              <li><Link className="dropdown-item d-flex align-items-center" href="#!"><i className="fe fe-user p-1 rounded-circle bg-primary-transparent me-2 fs-16"></i>Profile</Link></li>
              <li><Link className="dropdown-item d-flex align-items-center" href="#!"><i className="fe fe-mail p-1 rounded-circle bg-primary-transparent me-2 fs-16"></i>Mail Inbox</Link></li>
              <li><Link className="dropdown-item d-flex align-items-center" href="#!"><i className="fe fe-database p-1 rounded-circle bg-primary-transparent klist me-2 fs-16"></i>File Manger<SpkBadge variant='primary1' Customclass="text-fixed-white ms-auto fs-9">2</SpkBadge></Link></li>
              <li><Link className="dropdown-item d-flex align-items-center" href="#!"><i className="fe fe-settings p-1 rounded-circle bg-primary-transparent ings me-2 fs-16"></i>Settings</Link></li>
              <li><Link className="dropdown-item dropdown-item d-flex align-items-center" href="#!"><i className="fe fe-help-circle p-1 rounded-circle bg-primary-transparent set me-2 fs-16"></i>Help</Link></li>
              <li><Link className="dropdown-item d-flex align-items-center" href="#!"><i className="fe fe-lock p-1 rounded-circle bg-primary-transparent ut me-2 fs-16"></i>Log Out</Link></li>
            </SpkDropdown>
            {/* <!-- End::header-element --> */}
