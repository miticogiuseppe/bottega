...
const SpkDropdown = ({
  ...
  return (
    <Fragment>
      ...
      >
        {Buttontag && Buttonposition === "before" ? (
          <SpkButton Buttonvariant={color}>{Buttontext}</SpkButton>
        ) : (
          ""
        )}
        <>
          <Dropdown.Toggle
            ...
            className={`btn ${Customtoggleclass}`}
            type="button"
            href={Navigate}
            size={Size}
            id={Id}
          ...
          >
            {iconPosition === "before" ? (
              <>
                {Imagetag ? (
                  <img src={Imagesrc} alt={Imagename} className={Imageclass} />
                ) : (
          ...
          {Buttontag && Buttonposition === "after" ? (
            <SpkButton Buttonvariant={color}>{Buttontext}</SpkButton>
          ) : (
            ""
          )}
